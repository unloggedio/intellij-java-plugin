...
public class UIUtils {
    ...
    public static final Icon MS_TEAMS_ICON = IconLoader.getIcon("/icons/svg/icons8-microsoft-teams.svg", UIUtils.class);
    public static final Icon SLACK_ICON = IconLoader.getIcon("/icons/svg/icons8-slack.svg", UIUtils.class);
    public static final Icon GMAIL_ICON = IconLoader.getIcon("/icons/svg/icons8-gmail.svg", UIUtils.class);
    ...
    public static final Icon DELETE_BIN_CROSS_BLACK = IconLoader.getIcon("icons/svg/delete-bin-2-line.svg",
            UIUtils.class);
    public static final Icon DELETE_BIN_PARALLEL_RED = IconLoader.getIcon("icons/svg/delete-bin-6-line.svg",
            UIUtils.class);
