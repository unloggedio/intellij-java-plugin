...
public class CodeFragmentEvaluator
    ...
    private static final Logger logger = LoggerUtil.getInstance(CodeFragmentEvaluator.class);
    ...
    public Value getValue(String localName, InsidiousVirtualMachineProxy vmProxy) throws EvaluateException {
        ...
        logger.error("unknown default initializer type " + value.getClass().getName());
        return null;
    }
