...
public abstract class InsidiousCachedEvaluator {
        ...
        try {
            ...
            if (context == null) {
                throw EvaluateExceptionUtil.createEvaluateException(
                        DebuggerBundle.message("evaluation.error.cannot.find.source", className));
            }
            ...
            try {
                cache
                        ...
                        .myEvaluator = EvaluatorBuilderImpl.getInstance().build(codeFragment, null, evaluationContext);
    ...
    protected ExpressionEvaluator getEvaluator(Project project, EvaluationContext evaluationContext) throws EvaluateException {
        ...
        if (cache == null) {
            ...
            cache = WriteAction.compute(() -> initEvaluatorAndChildrenExpression(project, evaluationContext));
        }
