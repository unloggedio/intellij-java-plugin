...
import com.insidious.plugin.extension.thread.InsidiousStackFrameContext;
    ...
    public InsidiousStackFrameDescriptorImpl(@NotNull InsidiousStackFrameProxy frame, @NotNull MethodsTracker tracker) {
        ...
        try {
            ...
            if (this.myProcess instanceof InsidiousJavaDebugProcess) {
                InsidiousJavaDebugProcess InsidiousJavaDebugProcess = (com.insidious.plugin.extension.InsidiousJavaDebugProcess) this.myProcess;
