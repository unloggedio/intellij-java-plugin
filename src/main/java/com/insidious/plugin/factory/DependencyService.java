...
//            return;
//        }
//        @NotNull LibraryTable librariesTable = LibraryTablesRegistrar.getInstance().getLibraryTable(project);
...
//                    || libraryName.startsWith("Maven:")
//            ) {
//                if (libraryName.contains("com.fasterxml.jackson.core:jackson-core")) {
...
//            String jacksonDatabindVersion = insidiousService.getProjectTypeInfo()
//                    .getJacksonDatabindVersion();
//            if (jacksonDatabindVersion != null) {
//                String jacksonVersionFromProjectType = jacksonDatabindVersion.split("-")[1];
