...
//
//            dependentObjectCreation = new ObjectRoutineContainer(testCaseGenerationConfiguration, dependentParameter);
...
//                // in the test case it looks something like
//                // Integer varName = value;
//                ObjectRoutineContainer dependentContainer = new ObjectRoutineContainer(testCaseGenerationConfiguration, dependentParameter);
...
//
//
//        ObjectRoutineContainer objectRoutineContainer = new ObjectRoutineContainer(testCaseGenerationConfiguration, parameter);
...
//                            );
//
//                    callsList.addAll(staticMethodCallList);
