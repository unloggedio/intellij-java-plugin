...
//		logger.info("--------------------");
//		NetworkSessionInstanceClient networkSessionInstanceClient = new NetworkSessionInstanceClient("http://localhost:8123", "1", new ServerMetadata(), this.project);
...
//		logger.info("--------------------");
//		List<ExecutionSession> executionSessionList = networkSessionInstanceClient.sessionDiscovery("temp-package");
//		for (ExecutionSession localExecutionSession: executionSessionList) {
//			logger.info("localExecutionSession = " + localExecutionSession);
//		}
//		logger.info("--------------------");
