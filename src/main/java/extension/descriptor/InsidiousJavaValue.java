...
import extension.evaluation.EvaluationValue;
...
public class InsidiousJavaValue extends XNamedValue implements InsidiousNodeDescriptorProvider {
    private static final Logger LOG = Logger.getInstance(InsidiousJavaValue.class);
    ...
    public void computePresentation(@NotNull final XValueNode node, @NotNull final XValuePlace place) {
        ...
        this.myValueDescriptor.updateRepresentationNoNotify(this.myEvaluationContext.getVirtualMachineProxy().getXDebugProcess(), new DescriptorLabelListener() {
                    public void labelChanged() {
                        ...
                        if (!fullEvaluatorSet) {
                            ...
                            if (text.length() > 1000) {
                                node.setFullValueEvaluator(new JavaFullValueEvaluator(InsidiousJavaValue.this.myEvaluationContext) {
                                                               public void evaluate(@NotNull final XFullValueEvaluator.XFullValueEvaluationCallback callback) {
                                                                   ...
                                                                   fullValueDescriptor.updateRepresentation(this.myEvaluationContext.getVirtualMachineProxy().getXDebugProcess(), new DescriptorLabelListener() {
                                                                               public void labelChanged() {
...
//                            ReadAction.run(());
    ...
    public void computeChildren(@NotNull final XCompositeNode node) {
        this.myValueDescriptor.getChildrenRenderer().thenAccept(r -> r.buildChildren(this.myValueDescriptor.getValue(), new InsidiousChildrenBuilder() {
                ...
                if (!nodes.isEmpty()) {
                    ...
                    for (InsidiousDebuggerTreeNode treeNode : nodes) {
                        ...
                        if (descriptor instanceof InsidiousValueDescriptorImpl) {
                            childrenList.add(InsidiousJavaValue.create(InsidiousJavaValue.this, (InsidiousValueDescriptorImpl) descriptor, InsidiousJavaValue.this.myEvaluationContext, InsidiousJavaValue.this.myNodeManager, false));
                            continue;
                        }
...
/* Location:              D:\workspace\code\LR4J-IntelliJ-Plugin-6.6.1\lr4j-IntelliJ\li\\Insidious-intellij-6.6.1\!\i\\Insidious\intellij\debugger\descriptor\InsidiousJavaValue.class
