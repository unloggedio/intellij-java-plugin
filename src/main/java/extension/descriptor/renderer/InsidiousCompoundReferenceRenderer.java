...
public class InsidiousCompoundReferenceRenderer
    ...
    protected static final Logger LOG = Logger.getInstance(InsidiousCompoundReferenceRenderer.class);
    ...
    public InsidiousCompoundReferenceRenderer(String name, InsidiousValueLabelRenderer labelRenderer, InsidiousChildRenderer childrenRenderer) {
        ...
        LOG.assertTrue((labelRenderer == null || labelRenderer instanceof InsidiousReferenceRenderer));
        LOG.assertTrue((childrenRenderer == null || childrenRenderer instanceof InsidiousReferenceRenderer));
    }
...
/* Location:              D:\workspace\code\LR4J-IntelliJ-Plugin-6.6.1\lr4j-IntelliJ\li\\Insidious-intellij-6.6.1\!\i\\Insidious\intellij\debugger\descriptor\render\InsidiousCompoundReferenceRenderer.class
