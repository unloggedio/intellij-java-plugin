...
public class DebuggerUtil {
    private static final Logger logger = Logger.getInstance(DebuggerUtil.class);
...
/* Location:              D:\workspace\code\LR4J-IntelliJ-Plugin-6.6.1\lr4j-IntelliJ\li\\Insidious-intellij-6.6.1\!\i\\Insidious\intelli\\util\DebuggerUtil.class
